...
function AdvanceKamciliDisUnitesiA1() {
  var settings = {
    dots: true,
    infinite: true,
    speed: 200,
  ...
  const filteredProducts = Products[3].product.filter(
    (product) => product.model !== "Advance Kamçılı Diş Ünitesi A1"
  );
  return (
    <div>
...
export default AdvanceKamciliDisUnitesiA1;

export const AdvanceKamciliDisUnitesiA1Title = () => {
  const pdfDownloader = () => {};
  return (
      ...
      <MKBox component="section">
        ...
        >
          ...
          <Grid container item sx={{ justifyContent: "flex-start" }}>
            ...
            >
              Advance Kamçılı Diş Ünitesi A1
            </MKTypography>
          </Grid>
        </Container>
        <MKTypography
