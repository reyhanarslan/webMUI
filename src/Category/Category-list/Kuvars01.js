...
function Kuvars01() {
  ...
  const filteredProducts = Products[5].product.filter((product) => product.model !== "KUVARS 01");
  return (
    <div>
        ...
        <Container>
          <Grid container spacing={3} alignItems="center">
            <Grid item xs={12} lg={8}>
              ...
              <li className="page-content">Tezgah için corian seçeneği</li>
...
export default Kuvars01;

export const Kuvars01Title = () => {
  return (
          ...
          >
            ...
            <Grid item xs={12} lg={12}>
              <div className="page-title">
                ...
                {"(E x D x Y) 500 x 2100 x 730. (±50 mm)"}
                <br />
                Üst Bölüm: Cam
                <br />
                Lavabo: Cam
