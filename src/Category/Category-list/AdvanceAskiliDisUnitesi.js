...
function AdvanceAskiliDisUnitesi() {
  var settings = {
    dots: true,
    infinite: true,
    speed: 200,
  ...
  const filteredProducts = Products[3].product.filter(
    (product) => product.model !== "Advance Askılı Diş Ünitesi"
  );
  return (
    <div>
          ...
          <Grid container spacing={3} alignItems="center">
            <Grid item xs={12} lg={8}>
              ...
              <li className="page-content">
                Doktorun hastaya yaklaşmasını kolaylaştıran “Yakın dikkat” tasarımlı sırtlık
              </li>
              <li className="page-content">
              ...
              <li>Sırtlık ve ayaklığın hastayı rahatsız etmeyen senkronize hareketi</li>
              <li>24 V DC motorları destekleyen amortisör sistemi</li>
              <br />
              ...
              <li>Hekimin Rahat çalışabilmesi için tasarlanmış geniş enstrüman tablası</li>
              <br />
              ...
              <br />
              <div className="page-title">Kreşuar</div>
              <li>
                Koltuğa monte pnömatik sistemli 90 derece dönebilen seramik çanaklı kreşuar.
                Zamanlanabilir ve otoklavlanabilir bardak doldurucu ve çanak yıkayıcı
              </li>
              <br />
              <div className="page-title">Ayak Pedalı</div>
              <li>Başlıkların hızını ve koltuğun hareketlerini kumanda eden ayak pedalı</li>
              <br />
...
export default AdvanceAskiliDisUnitesi;

export const AdvanceAskiliDisUnitesiTitle = () => {
  const pdfDownloader = () => {};
  return (
    <div>
