...
function AdvanceKamciliDisUnitesi() {
  var settings = {
    dots: true,
    infinite: true,
    speed: 200,
  ...
  const filteredProducts = Products[3].product.filter(
    (product) => product.model !== "Advance Kamçılı Diş Ünitesi"
  );
  return (
    <div>
...
export default AdvanceKamciliDisUnitesi;

export const AdvanceKamciliDisUnitesiTitle = () => {
  const pdfDownloader = () => {};
  return (
    <div>
